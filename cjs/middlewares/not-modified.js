...
function notModified(options = {}) {
  return async context => {
    ...
    const isNotModified = isEtagNotModified && isLastModifiedRecentEnough || isEtagNotModified && !shouldSetLastModified || !shouldSetEtag && isLastModifiedRecentEnough;

    if (isNotModified) {
      responseStatus = 304;
      delete responseHeaders['content-type'];
      delete responseHeaders['content-length'];
      delete responseHeaders['content-encoding']; // TODO test this and check this is accurate

      delete responseHeaders['access-control-allow-origin'];
      delete responseHeaders['access-control-allow-methods']; // TODO test this
