...
http
  .createServer(
    hititipi(async (context) => {
      context.responseHeaders.set('server', 'server name');
      context.responseHeaders.set('referrer-policy', 'same-origin');
      ...
      context.responseHeaders.set('last-modified', 'Sun, 27 Oct 2024 10:17:29 GMT');
